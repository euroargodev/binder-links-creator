...
function changeTab(div) {
    ...
    if (id.includes("binder")) {
        ...
        env_repo_branch.value = "main";
        env_repo.placeholder = "https://github.com/euroargodev/binder-sandbox";
        env_repo.value = "https://github.com/euroargodev/binder-sandbox";

        content_repo.hidden = false;
        content_branch.hidden = false;
//         content_repo.placeholder = "https://github.com/euroargodev/test";
    } else {
